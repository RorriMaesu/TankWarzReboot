...
export class AIController {
    constructor(config, terrain) {
        ...
        this.biasPower = 0; // Remembers adjustment offset across turns
        this.config = config;
     ...
     */
    decideShot(aiPosition, targetPosition, difficulty, aiFuel, hasNuke) {
     ...
     */
    registerFeedback(landingX, targetX, aiX) {
